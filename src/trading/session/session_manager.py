...
class SessionManager:
    ...
    def update_available_balance(self, asset_key: int, available_balance: float) -> None:
    ...
    def _record_buy_position(context: TradingContext, market_data: MarketData) -> None:
        ...
        context.lowest_buy = min(context.lowest_buy, price)
        context.highest_buy = max(context.highest_buy, price)
        context.open_positions.append(market_data)

    @staticmethod
    def _record_sell_position(context: TradingContext, market_data: MarketData) -> None:
        price = float(market_data.close_price)
        context.lowest_sell = min(context.lowest_sell, price)
