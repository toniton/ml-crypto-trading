...
class TestPortfolioHelper(TestCase):
    ...
    def test_portfolio_value_with_open_buy_positions(self):
        ...
        self.assertEqual(Decimal("1165.0"), result)

    def test_portfolio_value_fractional_btc(self):
        open_positions = [
            PositionEntry(
                price="84000.0",
                quantity="0.000035",
        ...
        result = PortfolioHelper.calculate_portfolio_value(
            available_balance=Decimal("7.61"),
            current_price="84000.0",
            open_positions=open_positions,
        )
        self.assertEqual(Decimal("10.55"), result)
    ...
    def test_unrealized_pnl_mixed_positions(self):
        ...
        self.assertEqual(Decimal("2.50"), result)
    ...
    def test_unrealized_pnl_ignores_open_sell(self):
        ...
        self.assertEqual(Decimal("-5.00"), result)
    ...
    def test_peak_value_excludes_last_position(self):
        ...
        # 1000 -> Buy(100 * 2) -> 800. Sell(200 * 2) -> 1200.
        self.assertEqual((Decimal("1200.0"), 200.0), result)
    ...
    def test_trough_value_with_recovery(self):
        ...
        self.assertEqual(result, (Decimal("500.0"), 0.0))
